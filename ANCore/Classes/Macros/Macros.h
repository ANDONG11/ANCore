...
// 字体适配
#define font(R)              (R)*(dSCREEN_WIDTH)/375.0     //这里是iPhone 6屏幕字体
#define sysFont_Light(f)     [UIFont fontWithName:@"STHeitiSC-Light" size:autoScaleW(f)]
#define sysFont_Regular(f)   [UIFont fontWithName:@"PingFangSC-Regular" size:(f)]
