...
+ (void)openCrashGuard {
    ...
    an_swizzleInstanceMethod(__NSDictionaryM, @selector(setObject:forKey:), @selector(guardSetObject:forKey:));
    an_swizzleInstanceMethod(__NSDictionaryM, @selector(removeObjectForKey:), @selector(guardRemoveObjectForKey:));
    an_swizzleInstanceMethod(__NSDictionaryM, @selector(setObject:forKeyedSubscript:), @selector(guardSetObject:forKeyedSubscript:));
